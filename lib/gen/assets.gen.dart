...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/no_employee.png
  AssetGenImage get noEmployee =>
      const AssetGenImage('assets/images/no_employee.png');

  /// List of all assets
  List<AssetGenImage> get values => [flutterLogo, noEmployee];
}
...
class $AssetsSvgsGen {
  ...
  /// File path: assets/svgs/employee_icon.svg
  SvgGenImage get employeeIcon =>
      const SvgGenImage('assets/svgs/employee_icon.svg');

  /// File path: assets/svgs/job_role.svg
